...
#
# PRO_GALLERY_LIMIT is deliberately NOT advertised anywhere in the product: Stagify+ is
# sold as unlimited STAGING, which it is — this caps the convenience history, and 200 is
# far past what anyone reaches. An eviction that breaks a LIVE SHARE LINK is still
# reported to the owner regardless of tier; not advertising a ceiling is a marketing
# choice, letting a client's link die in silence is a broken product.
