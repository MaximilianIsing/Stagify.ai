...
(function (global) {
  ...
  SupademoPlayer.prototype.go = function (idx, immediate) {
    ...
    if (st.img !== this.currentSrc) {
      ...
      var self = this;
      var swap = function () { incoming.classList.add('is-shown'); outgoing.classList.remove('is-shown'); };
  ...
  var api = { mount: function (root, demo) { return new SupademoPlayer(root, demo); } };
