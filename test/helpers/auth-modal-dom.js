...
// template (profile-menu/auth-modal-template.js) for its `id="…"` attributes, so a
// fixture cannot drift from the markup it stands in for. If the template gains an
...
const TEMPLATE = path.join(ROOT, 'public', 'scripts', 'profile-menu', 'auth-modal-template.js');

/** Every `id="…"` in the shipped modal template. */
 ...
 *
 * @param {{ user?: any, token?: string|null, fetchImpl?: Function }} [opts]
 * @returns {{
 *   el: (id: string) => any,
 *   toggleEl: any,
 *   document: any,
