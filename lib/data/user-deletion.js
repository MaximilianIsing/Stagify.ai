...
export function createUserDeletion(deps) {
  ...
  // This module WRITES tombstones, so it owns making sure the table is there rather
  // than depending on createBlobTombstones having been constructed first. IF NOT EXISTS
  // makes the duplicate exec free, and one exported schema means they cannot drift.
