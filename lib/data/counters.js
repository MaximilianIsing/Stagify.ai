...
// Same rule the CSV writer in lib/services/logging.js uses: Render's mounted disk
// if we're on Render, else the project data folder.
function defaultLogDir() {
  if (process.env.RENDER && fs.existsSync('/data')) return '/data';
