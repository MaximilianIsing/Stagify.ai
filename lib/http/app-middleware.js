...
export function applyEdgeMiddleware(app) {
  ...
  const cspDirectives = {
    ...
    scriptSrc: [
      ...
      // pulls in conversion/remarketing scripts from googleadservices.com and
      // www.google.com. Config + loader live in public/scripts/gtag.js; the
      // measurement beacons themselves ride on imgSrc/connectSrc 'https:' below.
    ...
    frameSrc: [
      ...
      'https://accounts.google.com',
      'https://*.stripe.com',
      // Google Ads conversion-linker / remarketing cookie-sync iframe.
