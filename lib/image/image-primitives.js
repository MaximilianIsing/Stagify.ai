...
/**
 * Downscale an image to fit within 1920×1080, preserving aspect ratio. Returns the
 * source buffer untouched when it already fits; otherwise re-encodes as JPEG q90.
 * @param {Buffer} imageBuffer - Source image bytes.
 * @returns {Promise<Buffer>} The downscaled JPEG buffer, or the original buffer when no resize was needed.
