...
import { downscaleImage, enforceAspectRatio, padBufferToAspectRatio, orientedDimensions, upscaleForDelivery } from '../image/image-primitives.js';
    ...
    try {
      ...
      if (srcDims) {
        ...
        if (m) {
          ...
          finalDataUrl = `data:image/png;base64,${fixed.toString('base64')}`;
        }
      }
