...
//   STAGING_DISCLOSURE_BADGE = the IDENTIFICATION. One short sentence burned into the
 ...
 *
 * Kept to one plain sentence in every language: it has to stay legible at ~2% of the
 * image's long edge, and a corner stamp that wraps to two lines reads as a watermark
 * rather than as a disclosure.
 * @type {Record<string, string>}
 */
export const STAGING_DISCLOSURE_BADGE = {
  english: 'This image has been virtually staged',
  spanish: 'Esta imagen ha sido amueblada virtualmente',
  french: 'Cette image a été meublée virtuellement',
  german: 'Dieses Bild wurde virtuell möbliert',
  dutch: 'Deze afbeelding is virtueel ingericht',
  italian: 'Questa immagine è stata arredata virtualmente',
  portuguese: 'Esta imagem foi mobiliada virtualmente',
  russian: 'Это изображение виртуально меблировано',
  chinese: '此图片经过虚拟布置',
  japanese: 'この画像はバーチャルステージングされています',
  korean: '이 이미지는 가상으로 스테이징되었습니다',
};
