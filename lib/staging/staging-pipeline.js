...
/**
 * @param {(attempt: number) => (Promise<string|null>|string|null)} generateOnce
 * @param {{
 *   label?: string,
 *   onImageProduced?: ((attempt: number) => void) | null,
 *   reviewFn?: (url: string) => Promise<{ perfect: boolean, score: number }>,
 *   maxAttempts?: number,
 *   debug?: boolean,
 * }} [options] `reviewFn` and `maxAttempts` are typed optional because the `= {}`
 *   default allows omission; they are validated as required at runtime below.
 */
