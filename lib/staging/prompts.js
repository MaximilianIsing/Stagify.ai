...
export const STAGEABLE_IMAGE_CHECK_PROMPT =
  ...
  'Reject ONLY when the image is clearly NEITHER a property space NOR furniture — for ' +
  'example a selfie or portrait where a person or pet fills the frame, food, a ' +
  'screenshot/document/text, a car or other vehicle, a meme, or an unrelated object or ' +
  'product that is not furniture or home decor. When you are unsure, answer VALID: true.\n' +
  ...
  'under 20 words, telling the user to upload a photo of a room, space, or furniture instead>".';
 ...
 */
export function maskReferencePromptSuffix() {
