 ...
 * the JSON response.
 * @param {{ genAI: { getGenerativeModel: (options: any) => any }, requireProAccount: (req: import('express').Request, res: import('express').Response) => any, MAX_MASK_PROMPT_LENGTH: number, QUALITY_MAX_ATTEMPTS: number, DEBUG_MODE: boolean, downscaleImage: Function, padBufferToAspectRatio: Function, buildMarkedRoomImage: Function, normalizeMaskOutputToRoom: Function, reviewMaskEdit: Function, compositeForReview: Function, generateWithQualityRetry: Function, maskReferencePromptSuffix: Function, logMaskEditToFile: Function, getUserIdentifier: Function, enterpriseDomainForUser: Function, reportEnterpriseUsage: Function }} deps - Injected AI client, pro gate, limits, image helpers, the POSITIONAL-signature generateWithQualityRetry, prompt-suffix + CSV-logging helpers, and enterprise-usage metering.
