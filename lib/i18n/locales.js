...
export const LOCALIZED_PAGES = [
  { path: '/',                    file: 'index.html',          lastmod: '2026-07-27', changefreq: 'weekly',  priority: '1.0',  crumb: 'navigation.home' },
  { path: '/ai-designer.html',    file: 'ai-designer.html',    lastmod: '2026-07-17', changefreq: 'weekly',  priority: '0.9',  crumb: 'navigation.pdfTo3d' },
  { path: '/masking-studio.html', file: 'masking-studio.html', lastmod: '2026-07-10', changefreq: 'weekly',  priority: '0.9',  crumb: 'navigation.maskingStudio' },
  { path: '/exterior-studio.html', file: 'exterior-studio.html', lastmod: '2026-08-03', changefreq: 'weekly', priority: '0.9', crumb: 'navigation.exteriorStudio' },
  { path: '/stagify-plus.html',   file: 'stagify-plus.html',   lastmod: '2026-07-10', changefreq: 'monthly', priority: '0.85', crumb: 'navigation.plusBadge' },
  { path: '/enterprise.html',     file: 'enterprise.html',     lastmod: '2026-07-10', changefreq: 'monthly', priority: '0.85', crumb: 'enterprise.hero.title' },
  { path: '/guides.html',         file: 'guides.html',         lastmod: '2026-07-10', changefreq: 'monthly', priority: '0.8',  crumb: 'navigation.guides' },
  { path: '/contact.html',        file: 'contact.html',        lastmod: '2026-07-10', changefreq: 'monthly', priority: '0.6',  crumb: 'navigation.contactUs' },
  { path: '/status',              file: 'status.html',         lastmod: '2026-07-10', changefreq: 'monthly', priority: '0.3',  crumb: 'status.heading' },
];
