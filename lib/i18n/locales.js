...
export const LOCALIZED_PAGES = [
  { path: '/',                    file: 'index.html',          lastmod: '2026-07-27', changefreq: 'weekly',  priority: '1.0'  },
  ...
  { path: '/exterior-studio.html', file: 'exterior-studio.html', lastmod: '2026-08-03', changefreq: 'weekly', priority: '0.9' },
