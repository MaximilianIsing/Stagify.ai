...
/**
 * English-only pages that are NOT part of the localized set: the blog, and the two
...
const ENGLISH_ONLY_ENTRIES = [
  { loc: `${SITE_ORIGIN}/terms.html`, lastmod: '2026-08-08', changefreq: 'yearly', priority: '0.3' },
  { loc: `${SITE_ORIGIN}/privacy.html`, lastmod: '2026-07-10', changefreq: 'yearly', priority: '0.3' },
  { loc: `${SITE_ORIGIN}/blog/`, lastmod: '2026-09-09', changefreq: 'weekly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/is-virtual-staging-allowed-on-the-mls`, lastmod: '2026-08-11', changefreq: 'monthly', priority: '0.7' },
  ...
  { loc: `${SITE_ORIGIN}/blog/top-10-ai-virtual-staging-sites-2026`, lastmod: '2026-07-22', changefreq: 'monthly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/dorm-room-design-ai-college-freshmen`, lastmod: '2026-07-27', changefreq: 'monthly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/prepare-your-listing-for-the-fall-market`, lastmod: '2026-08-03', changefreq: 'monthly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/curb-appeal-real-estate-photos`, lastmod: '2026-08-07', changefreq: 'monthly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/free-virtual-staging`, lastmod: '2026-08-11', changefreq: 'monthly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/virtual-staging-disclosure-laws-by-state`, lastmod: '2026-08-11', changefreq: 'monthly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/fsbo-listing-photos`, lastmod: '2026-08-14', changefreq: 'monthly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/new-construction-listing-photos`, lastmod: '2026-08-16', changefreq: 'monthly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/virtual-staging-api`, lastmod: '2026-09-02', changefreq: 'monthly', priority: '0.7' },
  { loc: `${SITE_ORIGIN}/blog/home-staging-cost`, lastmod: '2026-09-09', changefreq: 'monthly', priority: '0.7' },
];
