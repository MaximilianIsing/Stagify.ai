...
export function handleStripeEvent(event, authStore, { stripe, enterpriseStore } = /** @type {{ stripe?: any, enterpriseStore?: any }} */ ({})) {
  switch (event.type) {
    case 'checkout.session.completed': {
      ...
      if (!result.ok) {
        ...
        logger.info('[stripe] Stagify+ activated for', result.email);
      }
