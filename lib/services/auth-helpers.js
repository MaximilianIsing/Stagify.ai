 ...
 * @returns {{ enhanceUserWithEnterprise: (user: any) => any, getAuthUserFromRequest: (req: import('express').Request) => any, toPublicAuthUser: (user: any) => any, enterpriseDomainForUser: (user: any) => string | null, reportEnterpriseUsage: (domain: string, quantity?: number) => void, requireProAccount: (req: import('express').Request, res: import('express').Response) => any }} The auth/enterprise request helpers.
 */
