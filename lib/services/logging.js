 ...
 * @returns {{ getDataLogDir: () => string, escapeCsvField: (field: any) => string, logPromptToFile: (promptText: string, roomType: string, furnitureStyle: string, additionalPrompt: string, removeFurniture: boolean | string, userRole: string, userReferralSource: string, userEmail: string, req: import('express').Request) => void, logMaskEditToFile: (prompt: string, model: string, geminiModel: string, imageWidth: number, imageHeight: number, userId: string, req: import('express').Request) => void, logChatToFile: (userId: string, userMessage: string, aiResponse: string, files: any[], ipAddress: string, userAgent: string) => void }} The CSV logging API.
 */
