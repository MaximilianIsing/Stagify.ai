...
//
// NOTE: a handful of the original debug logs were gated on DEBUG_MODE in one
// handler but not the other (pure logging inconsistencies). Here they are
// uniform: emitted via logger.debug (which the debug threshold gates). No
// functional behavior changed.
import { DESIGNER_ROUTING_RESPONSE_FORMAT, DUAL_UPLOAD_ROOM_PROMPT_SUFFIX } from '../staging/prompts.js';
