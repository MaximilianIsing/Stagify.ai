 ...
 * @returns {{ buildUploadUserContent: (args: any) => any, buildUploadMessages: (args: any) => Promise<any>, logUploadPayload: (args: any) => void, runUploadRouting: (args: any) => Promise<any> }} The upload-prep API (buildUploadUserContent, buildUploadMessages, logUploadPayload, runUploadRouting).
 */
