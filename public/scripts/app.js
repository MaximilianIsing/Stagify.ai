import { abbreviateFileName, dataURLToFile } from './app/helpers.js';
    ...
    // The canvas math (brush-grow, model mask, feathered blend mask, composite)
    // lives once in the ES module scripts/mask-core.js and is shared with the AI
    // Designer. These thin wrappers keep every call site below unchanged; the
    // module loads eagerly and is awaited in runGenerate before its first use.
    let _maskCore = null;
